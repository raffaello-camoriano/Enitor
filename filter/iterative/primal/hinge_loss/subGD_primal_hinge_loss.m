classdef subGD_primal_hinge_loss < filter
    ...
    methods
        ...
        function obj = subGD_primal_hinge_loss( X , Y , numSamples , varargin)
        ...
        function compute(obj)
            ...
            Ypred = obj.X * obj.weights;
            I = Ypred .* obj.Y < 1;
            obj.weights = obj.weights + obj.eta * obj.currentPar^obj.theta * obj.X' * (I.*obj.Y);
        end
