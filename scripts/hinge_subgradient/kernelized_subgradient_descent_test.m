...
%     ds.lossFunction = @classificationError;
    ...
    expSGD_kernel_hinge_loss = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    
    expSGD_kernel_hinge_loss.run();
    expSGD_kernel_hinge_loss.result
    
    SGD_trainTime(k) = expSGD_kernel_hinge_loss.time.train;
    SGD_testTime(k) = expSGD_kernel_hinge_loss.time.test;
    SGD_perf(k) = expSGD_kernel_hinge_loss.result.perf;
    SGD_trainErr = [SGD_trainErr ; expSGD_kernel_hinge_loss.algo.trainPerformance'];
    SGD_valErr = [SGD_valErr ; expSGD_kernel_hinge_loss.algo.valPerformance'];
    SGD_testErr = [SGD_testErr ; expSGD_kernel_hinge_loss.algo.testPerformance'];
    ...
    expSGD2_kernel_hinge_loss = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    
    expSGD2_kernel_hinge_loss.run();
    expSGD2_kernel_hinge_loss.result
    
    SGD2_trainTime(k) = expSGD2_kernel_hinge_loss.time.train;
    SGD2_testTime(k) = expSGD2_kernel_hinge_loss.time.test;
    SGD2_perf(k) = expSGD2_kernel_hinge_loss.result.perf;
    SGD2_trainErr = [SGD2_trainErr ; expSGD2_kernel_hinge_loss.algo.trainPerformance'];
    SGD2_valErr = [SGD2_valErr ; expSGD2_kernel_hinge_loss.algo.valPerformance'];
    SGD2_testErr = [SGD2_testErr ; expSGD2_kernel_hinge_loss.algo.testPerformance'];
    ...
    expSGD3_kernel_hinge_loss = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    
    expSGD3_kernel_hinge_loss.run();
    expSGD3_kernel_hinge_loss.result
    
    SGD3_trainTime(k) = expSGD3_kernel_hinge_loss.time.train;
    SGD3_testTime(k) = expSGD3_kernel_hinge_loss.time.test;
    SGD3_perf(k) = expSGD3_kernel_hinge_loss.result.perf;
    SGD3_trainErr = [SGD3_trainErr ; expSGD3_kernel_hinge_loss.algo.trainPerformance'];
    SGD3_valErr = [SGD3_valErr ; expSGD3_kernel_hinge_loss.algo.valPerformance'];
    SGD3_testErr = [SGD3_testErr ; expSGD3_kernel_hinge_loss.algo.testPerformance'];
    ...
    expSGD4_kernel_hinge_loss = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    
    expSGD4_kernel_hinge_loss.run();
    expSGD4_kernel_hinge_loss.result
    
    SGD4_trainTime(k) = expSGD4_kernel_hinge_loss.time.train;
    SGD4_testTime(k) = expSGD4_kernel_hinge_loss.time.test;
    SGD4_perf(k) = expSGD4_kernel_hinge_loss.result.perf;
    SGD4_trainErr = [SGD4_trainErr ; expSGD4_kernel_hinge_loss.algo.trainPerformance'];
    SGD4_valErr = [SGD4_valErr ; expSGD4_kernel_hinge_loss.algo.valPerformance'];
    SGD4_testErr = [SGD4_testErr ; expSGD4_kernel_hinge_loss.algo.testPerformance'];
    ...
    expSGD_IGD_kernel_hinge_loss_1 = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    expSGD_IGD_kernel_hinge_loss_1.run();
    ...
    alg = kigdesc( map , fil , ...
        ...
        'mapParGuesses' , mapParGuesses , ...
        'verbose' , 0 , ...
        'initialWeights' , expSGD_IGD_kernel_hinge_loss_1.algo.c, ...
        'storeFullTrainPerf' , storeFullTrainPerf , ...
        'storeFullValPerf' , storeFullValPerf , ...
        'storeFullTestPerf' , storeFullTestPerf);

    expSGD_IGD_kernel_hinge_loss_2 = experiment(alg , ds , 1 , true , saveResult , '' , resdir);
    
    expSGD_IGD_kernel_hinge_loss_2.run();
    expSGD_IGD_kernel_hinge_loss_2.result
...
%     SGD_IGD_perf(k) = expSGD_IGD_linear_hinge_loss.result.perf;
    SGD_IGD_trainErr = [SGD_IGD_trainErr ; [expSGD_IGD_kernel_hinge_loss_1.algo.trainPerformance' ; expSGD_IGD_kernel_hinge_loss_2.algo.trainPerformance'] ];
    SGD_IGD_valErr = [SGD_IGD_valErr ; [expSGD_IGD_kernel_hinge_loss_1.algo.valPerformance' ; expSGD_IGD_kernel_hinge_loss_2.algo.valPerformance'] ];
    SGD_IGD_testErr = [SGD_IGD_testErr ; [expSGD_IGD_kernel_hinge_loss_1.algo.testPerformance' ; expSGD_IGD_kernel_hinge_loss_2.algo.testPerformance'] ];
