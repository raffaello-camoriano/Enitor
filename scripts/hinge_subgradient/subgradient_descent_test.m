...
for k = 1:numRep
    ...
    %% Experiment 2 setup, subgradient descent, hinge loss, Gaussian kernel
...
figure
trainingTimes = [ expKRLS.result.time.train , expDACKRLS.result.time.train , expNysInc.result.time.train , expLandweber.result.time.train , expNuMethod.result.time.train expgdesc_kernel_hinge_loss.result.time.train];
bar(trainingTimes)
...
figure
trainingTimes = [ expKRLS.result.time.test , expDACKRLS.result.time.test , expNysInc.result.time.test , expLandweber.result.time.test , expNuMethod.result.time.test , expgdesc_kernel_hinge_loss.result.time.test];
bar(trainingTimes)
set(gca,'XTickLabel',{'KRLS', 'DACKRLS', 'incNKRLS', 'Landweber' , '\nu method', 'Subgr. SVM'})
title('Testing Times')
ylabel('Time (s)')
...
figure
testPerf = [ expKRLS.result.perf , expDACKRLS.result.perf , expNysInc.result.perf , expLandweber.result.perf , expNuMethod.result.perf , expgdesc_kernel_hinge_loss.result.perf];
bar(testPerf)
set(gca,'XTickLabel',{'KRLS', 'DACKRLS', 'incNKRLS', 'Landweber' , '\nu method', 'Subgr. SVM'})
