...
if size(expDACKRLS.algo.valPerformance,1)>1 && size(expDACKRLS.algo.valPerformance,2)>1 

elseif size(expDACKRLS.algo.valPerformance,1)>1 && size(expDACKRLS.algo.valPerformance,2)==1
    figure
